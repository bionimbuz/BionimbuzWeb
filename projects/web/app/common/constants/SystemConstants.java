...
public class SystemConstants {
    public static final String SPLIT_EXP_COMMA = "(\\s*;\\s*)|(\\s*,\\s*)";
    ...
    public static final String DEFAULT_EXECUTOR_JAR = "task-executor.jar";
    public static final String DEFAULT_COORDINATOR_JAR = "task-coordinator.jar";
}
