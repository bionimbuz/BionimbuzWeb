...
public class Routes {
    ...
    public static final String COMPUTING_REGIONS_ZONES_INSTANCES_NAME = COMPUTING + REGIONS + "/{region}" + ZONES + "/{zone}" + INSTANCES + "/{name}";
    public static final String COMPUTING_REGIONS_ZONES_INSTANCES_NAME_ = COMPUTING + REGIONS + "/{region:.+}" + ZONES + "/{zone:.+}" + INSTANCES + "/{name:.+}";
    ...
    public static final String SPACES_NAME_FILE_UPLOAD = STORAGE_SPACES + "/{name}" + FILES + "/{file}" + UPLOAD_URL;
    public static final String SPACES_NAME_FILE_UPLOAD_ = STORAGE_SPACES + "/{name:.+}" + FILES + "/{file:.+}" + UPLOAD_URL;
    public static final String SPACES_NAME_FILE_DOWNLOAD = STORAGE_SPACES + "/{name}" + FILES + "/{file}" + DOWNLOAD_URL;
    public static final String SPACES_NAME_FILE_DOWNLOAD_ = STORAGE_SPACES + "/{name:.+}" + FILES + "/{file:.+}" + DOWNLOAD_URL;

    /*
     * StatusController
     */
    public static final String IMALIVE = "/imalive";
    public static final String START_FAULT_INJECTION = "/startFaultInjection";
